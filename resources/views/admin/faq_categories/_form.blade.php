     ...
     <div class="col-md-6 form-group mb-3 align-self-center"> {{-- Pushed to end in LTR, start in RTL --}}
         <div class="form-check form-switch">
             ...
             <label class="form-check-label" for="is_active">فعالة</label>
              ...
              @enderror
              <small class="form-text text-muted d-block">الفئات غير الفعالة لن تظهر ولن يمكن ربط أسئلة جديدة بها.</small>
         </div>
     </div>
</div>
...
<div class="form-actions mt-4 pt-3 border-top">
    <button type="submit" class="btn btn-primary">
        <x-lucide-save class="icon-sm ms-1"/> {{ isset($faqCategory) ? 'تحديث الفئة' : 'إنشاء فئة' }}
    </button>
    <a href="{{ route('admin.faq-categories.index') }}" class="btn btn-secondary">إلغاء</a>
</div>
